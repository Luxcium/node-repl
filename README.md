...
If possible plesae first open an [issue](https://github.com/Luxcium/node-repl/issues) to describe the probleme...
Then open a pull request that fixes your issue...

I am using the [luxcium](https://github.com/Luxcium/node-repl/tree/luxcium) branch on my macOS and [pc-master-race](https://github.com/Luxcium/node-repl/tree/pc-master-race) branch fo my WSL on windows...
