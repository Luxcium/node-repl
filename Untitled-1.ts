...
@Luxcium
249
7.6k331fantasyland/fantasy-land
 Code Issues 25 Pull requests 6 Actions Projects 0 Security Insights
...
specification
 ...
 MIT
@davidchambers
davidchambers Merge pull request #316 from oncicaradupopovici/master …
Latest commit
0688b34
on 8 Oct
Type	Name	Latest commit message	Commit time
figures	add Filterable algebra	2 years ago
scripts	readme: reinstate readme and fix automated release workflow	9 months ago
test	integrate sanctuary-scripts	last year
.config	Version 4.0.0	9 months ago
.eslintrc.json	readme: reinstate readme and fix automated release workflow	9 months ago
.gitignore	integrate sanctuary-scripts	last year
.npmrc	Version 3.5.0	2 years ago
.travis.yml	setup travis (#161)	3 years ago
CONTRIBUTING.md	derive index.js and index.d.ts from canonical list of method names	9 months ago
LICENSE	Version 4.0.0	9 months ago
README.md	readme: reinstate readme and fix automated release workflow	9 months ago
implementations.md	Added Zion	last month
index.d.ts	derive index.js and index.d.ts from canonical list of method names	9 months ago
index.js	integrate sanctuary-scripts	last year
logo.png	Let the fantasy begin	7 years ago
names	derive index.js and index.d.ts from canonical list of method names	9 months ago
package.json	Version 4.0.1	9 months ago
 README.md
...
42 :: Integer, Number - "42 is a member of type Integer and Number".
